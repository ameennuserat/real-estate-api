...
public class PropertyController {
    ...
    @Operation(
            ...
            description = "Retrieves a paginated list of properties managed by a specific office"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Successfully retrieved properties for the office",
    ...
    public ResponseEntity<?> findAllByOfficeId(
        ...
        GlobalResponse response = GlobalResponse.builder()
                .status("success")
                .data(service.findAllByOfficeId(pageable, officeId))
                .build();
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Adds a new property to the real estate portfolio"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<?> update(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    required = true,
                    content = @Content(schema = @Schema(implementation = PropertyRequest.class))
            )
            @RequestBody PropertyRequest request) {
        GlobalResponse response = GlobalResponse.builder()
                .status("success")
